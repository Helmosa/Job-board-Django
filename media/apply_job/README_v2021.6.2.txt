...
"C:\Program Files\Java\jdk-13.0.2\bin\java.exe" -javaagent:BurpSuiteLoader_v2021.6.2.jar -noverify -jar burpsuite_pro_v2021.6.2.jar
...
copy license request from loaded burpsuite_pro_v2021.6.2.jar to burploader-old, copy license response and paste to BurpSuite, press next. Done.
